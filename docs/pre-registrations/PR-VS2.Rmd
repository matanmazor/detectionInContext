...
In this third Experiment, we tested the generalizability of this finding to a setting where expectation has the opposite effect on perception. In a previous Visual Search Experiment [@mazor2022prospective], searches were faster on average when the target was semantically incongruent relative to the distractors. In that study, however, the target was always present, and participants' task was to locate it in the array.  Here, we ask whether a similar advantage for target-distractor incongruency will be observed in decisions about the absence of a target.  
